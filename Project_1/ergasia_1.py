...
# -2- Here suits also the way Costas removed words not in vocabulary:
#       "valid_WordCounts = {k:v for k, v in WordCounts.items() if v>10}" (section "Replace OOV Words")
